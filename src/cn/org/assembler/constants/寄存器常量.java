...
public class 寄存器常量 {
  ...
  public static final String 双字节累加寄存器名 = "EAX";
  public static final String 双字节计数寄存器名 = "ECX";
  public static final String 双字节数据寄存器名 = "EDX";
  public static final String 双字节BX寄存器名 = "EBX";
  public static final String 双字节SP寄存器名 = "ESP";
  public static final String 双字节BP寄存器名 = "EBP";
  public static final String 双字节SI寄存器名 = "ESI";
  public static final String 双字节目标地址寄存器名 = "EDI";
  
  public static final HashSet<String> 四字节寄存器 = new HashSet<>();
  public static final HashSet<String> 双字节寄存器 = new HashSet<>();
  ...
  static {
    ...
    寄存器对应码.put(双字节累加寄存器名, 0);
    寄存器对应码.put(双字节计数寄存器名, 1);
    寄存器对应码.put(双字节数据寄存器名, 2);
    寄存器对应码.put(双字节BX寄存器名, 3);
    寄存器对应码.put(双字节SP寄存器名, 4);
    寄存器对应码.put(双字节BP寄存器名, 5);
    寄存器对应码.put(双字节SI寄存器名, 6);
    寄存器对应码.put(双字节目标地址寄存器名, 7);
    
    四字节寄存器.addAll(Arrays.asList(四字累加寄存器名, 四字计数寄存器名, 四字数据寄存器名, 四字BX寄存器名, 四字SP寄存器名, 四字BP寄存器名,
        四字SI寄存器名, 四字目标地址寄存器名));
    双字节寄存器.addAll(Arrays.asList(双字节累加寄存器名, 双字节计数寄存器名, 双字节数据寄存器名, 双字节BX寄存器名, 双字节SP寄存器名, 双字节BP寄存器名,
        双字节SI寄存器名, 双字节目标地址寄存器名));
  }
